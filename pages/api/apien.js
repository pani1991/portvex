const siteData = {
  ...
  logo: "/logo.png",
  fav: "./favicon.ico",
  url: "https://portvex.com/panel/api",
  ...
  urls: {
    ...
    active: "en/company",
    activists: "en/companies",
    blog: "en/bloge",
    centers: "en/centers",
    login: "https://portvex.com/panel/auth/login.php",
  },
  social: [
    {
      title: "Aparat",
  ...
  footer: {
    ...
    app_dsc:
      "With our Donalwood application, in addition to using the facilities in general, you can use the special discounts of the Portvex application",
    app_img: "/phone.png",
    about_title: "Portvex",
    about_dsc:
      "The Portvex site was created with the aim of connecting producers and consumers to each other and to the customer. We have launched the Holding 1400 site, which is a comprehensive and reliable platform for introducing and evaluating companies, products and services in various industries. We have categorized various sites into various topics and sub-topics like industry, agriculture, services, commerce, technology etc. We have also provided facilities to search, compare, communicate and buy through the site. Help us develop the domestic market and increase the competitiveness of Iranian companies.",
    about_links: [
      {
        title: "Portvex",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: "Product return procedures",
            link: "#",
          },
          {
            title: "Terms of Use",
      ...
      },
      {
        ...
        items: [
          {
            title: "possibility of express delivery",
            link: "#",
          },
          {
            title: "Possibility of payment on the spot",
            link: "#",
          },
          {
            title: "Service 7 days a week, 24 hours",
            link: "#",
          },
        ],
      },
    ...
    copyright:
      "Designed and implemented by Danesh Banyan Fanavaran Giti Afrooz Company",
    copyright_link: "#",
  },
  category: [
    {

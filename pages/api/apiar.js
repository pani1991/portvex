const siteData = {
  ...
  title: "Portvex",
  descripton: "Portvex",
  metaKeywords: ["العلامة 1", "العلامة 2"],
  urls: {
    support: "ar/support",
    supports: "ar/supports",
    product: "ar/product",
    products: "ar/products",
    active: "ar/company",
    activists: "ar/companies",
    blog: "ar/bloge",
    centers: "ar/centers",
  ...
  footer: {
    ...
    app_dsc:
    "مع تطبيق Donalwood الخاص بنا، بالإضافة إلى استخدام المرافق بشكل عام، يمكنك استخدام الخصومات الخاصة لتطبيق Portvex",
    app_img: "/phone.png",
    about_title: "Portvex",
    about_dsc:
      "تم إنشاء موقع Portvex بهدف ربط المنتجين والمستهلكين ببعضهم البعض وبالعملاء. لقد أطلقنا موقع القابضة 1400، وهو منصة شاملة وموثوقة للتعريف وتقييم الشركات والمنتجات والخدمات في مختلف الصناعات. لقد قمنا بتصنيف مواقع مختلفة في مواضيع مختلفة ومواضيع فرعية مثل الصناعة والزراعة والخدمات والتجارة والتكنولوجيا وما إلى ذلك. كما قدمنا ​​تسهيلات للبحث والمقارنة والتواصل والشراء من خلال الموقع. نريد المساعدة في تطوير السوق المحلية وزيادة القدرة التنافسية للشركات الإيرانية.",
    ...
    about_links: [
      ...
      },
      {
        ...
        items: [
          {
            title: "الأجوبة على الأسئلة المتداولة",
            link: "#",
          },
          {
            title:"إجراءات إرجاع المنتجات",
            link: "#",
          },
          {
      ...
      },
      {
        ...
        items: [
          {
            title: "خيار التسليم السريع",
            link: "#",
          },
          {
            title:"امكانية الدفع فوري",
            link: "#",
          },
          {
            title: "الخدمة 7 أيام في الأسبوع 24 ساعة",
            link: "#",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            title:"المحادثة على الإنترنت",
            link: "#",
          },
          {
            title:"التيار عبر الإنترنت",
            link: "#",
          },
        ],
      },
    ],
    copyright: " تصميم وتنفيذ مؤسسة جيتي افروز للتقنيين ",
    copyright_link: "#",
  },
  category: [
    {
    ...
    {
      id: 14,
      title: "المعدات والآلات الصناعية",
